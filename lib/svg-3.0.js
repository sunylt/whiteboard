...
* @license MIT
*
* BUILT: Sat Dec 01 2018 22:37:43 GMT+0100 (GMT+01:00)
*/;
var SVG = (function () {
	'use strict';
	...
	***/
	...
	function (_Container) {
	  ...
	  _createClass(G, [{
	    key: "x",
	    value: function x(_x) {
	      if (_x == null) return this.transform()['x'];
	      return this.move(_x, 0);
	    }
	  }, {
	    key: "y",
	    value: function y(_y) {
	      if (_y == null) return this.transform()['y'];
	      return this.move(0, _y);
	    }
	  }, {
	    key: "move",
	    value: function move(x, y) {
